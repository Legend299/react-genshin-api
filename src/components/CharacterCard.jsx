    ...
    return (
      <div className="flex h-screen">
        <div className="m-auto">
          <div role="status">
            <svg
              className="inline mr-4 w-32 h-32 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
              viewBox="0 0 100 101"
              fill="none"
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
        {character.map((item, index) => (
          <div class="overflow-hidden rounded-2xl bg-gray-50">
            {/* class="flex items-center h-[180px] overflow-hidden" */}

            <img
              // className='object-scale-down h-42 w-52 mx-auto'
            ...
            <div class="p-6">
              <div class="flex flex-col items-start justify-between sm:flex-row sm:items-center">
                <div>
                  ...
                  <h2 class="mt-2 text-lg font-semibold bg-slate-700 rounded-xl inline text-white p-2">
                    {item.name}
                  </h2>
                </div>
                <span class="mt-2 inline-block rounded-full p-3 text-lg font-medium text-black">
                  {item.vision}
                </span>
              </div>
